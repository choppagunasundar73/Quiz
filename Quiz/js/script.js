...
quit_quiz.onclick = ()=>{
    //window.location.href = 'login.html'; //reload the current window
}
...
const scriptURL = 'https://script.google.com/macros/s/AKfycbx9kqPii5TToyoa6b4JgH5vWyB_1MpJOaFITnkxxUEmWTQDIqiNuzX-u-Rw5kTedt95sA/exec'
